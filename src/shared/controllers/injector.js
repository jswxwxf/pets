...
const config = (Config) => {
    ...
    d.creditService = new CreditService(d.storeService);
    d.landingService = new LandingService(d.storeService);
    ...
    d.creditController = new CreditController(d.utilService, d.creditService);
    d.landingController = new LandingController(d.utilService, d.landingService);
